      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
            <h3>Computer Scientist &amp; Full-Stack Developer.</h3>
            <p class="fst-italic">
            ...
            <div class="row">
              <div class="col-lg-6">
                <ul>
                @foreach($getData as $profile)
                  <li><i class="bi bi-chevron-right"></i> <strong>Birthday:</strong> <span>{{ $profile->date_of_birth }}</span></li>
      ...
      <div class="container">
        ...
        <div class="row skills-content">
          ...
          <div class="col-lg-6" data-aos="fade-up">
            ...
            <div class="progress">
              <span class="skill">{{ __('HTML')}} <i class="val">100%</i></span>
    ...
    <section id="resume" class="resume">
      <div class="container">
        ...
        <div class="section-title">
          ...
          <h2>Resume</h2>
          <div class="col-lg-6" data-aos="fade-up">
            <h3 class="resume-title">Professional Sumary</h3>
          </div>
          ...
          <div class="col-lg-6" data-aos="fade-up">
            ...
            @foreach($getEdu as $edu)
             <div class="resume-item">
              ...
              <h5>{{ $edu->date_started }} - {{ $edu->date_obtained }} </h5>
